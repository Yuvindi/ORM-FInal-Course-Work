...
public class StudentRegisterController {
        ...
        tblStudentCourse.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                try {
                    ...
                    txtBatchNumber.setText(newSelection.getCourse_batch());
                    txtBatchNumber.setDisable(true);
    ...
    private void SetCellValue() {
        ...
        colBatchNumber.setCellValueFactory(new PropertyValueFactory<>("Course_batch"));
    }
    ...
    void btnAddOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        String course_batch =  courseDTO.getCourse_name()+" - "+ batch;
        ...
        Student_CourseDTO studentCourseDTO = new Student_CourseDTO(Student_courseID, student, course, date,course_batch);
    ...
    private void clear() throws SQLException, ClassNotFoundException {
        ...
        lblDuration.setText("");
        generateNextId();
        txtBatchNumber.setDisable(false);
    ...
    void btnUpdateOnAction(ActionEvent event) throws Exception {
        String contact = cmbStudentPhoneNumber.getValue();
        String CourseID = lblCourseID.getText();
        String course_batch = txtBatchNumber.getText();
